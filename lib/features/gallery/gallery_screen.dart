...
class GalleryScreen extends ConsumerlessMediaFeed {
  const GalleryScreen({super.key});
}

// Base class so PromotionsScreen can reuse
class ConsumerlessMediaFeed extends StatefulWidget {
  const ConsumerlessMediaFeed({super.key});

  @override
  State<ConsumerlessMediaFeed> createState() => _MediaFeedState();
}

class _MediaFeedState extends State<ConsumerlessMediaFeed> {
